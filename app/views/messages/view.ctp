<?php /* SVN: $Id: $ */ ?>
<?php echo $this->element('message_message-left_sidebar', array('cache' => Configure::read('cache.time.message_left_side')));?>
              ...
              <div class="form-content-block js-corner round-5">
                    ...
                    if (!empty($all_parents)) :
                     ...
                     <div class="mail-reply-button">
    					<?php
                            echo $this->Html->link($this->Html->image('reply-button.png') , array('controller' => 'messages', 'action' => 'compose',$parent_message['Message']['id'],'reply') , null, array('inline' => false)); ?>
                        </div>
                ...
                <div class="mail-date-time">
                    <p class="<?php echo $message['Message']['id'] ?>"><span class="js-show-mail-detail-span"><?php echo __l('show details'); ?></span>	
					<?php
                ...
                <div class="mail-reply-button"><?php
                    echo $this->Html->link($this->Html->image('reply-button.png') , array('controller' => 'messages', 'action' => 'compose', $message['Message']['id'],'reply') , null, array('inline' => false)); ?>
                </div>
			   ...
			   <div class="js-show-mail-detail-div" style="display:none;">
				...
				<?php
                    echo $this->Html->link(__l("Reply") , array('controller' => 'messages','action' => 'compose',$message['Message']['id'],'reply') , null, array('inline' => false));
