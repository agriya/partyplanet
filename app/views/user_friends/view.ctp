...
<h2><?php echo __l('User Friend');?></h2>
	<dl class="list"><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __l('User');?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>><?php echo $this->Html->link($this->Html->cText($userFriend['User']['username']), array('controller' => 'users', 'action' => 'view', $userFriend['User']['slug']), array('escape' => false));?></dd>
