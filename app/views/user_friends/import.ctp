...
<ul class="menu-tabs clearfix">
	...
	<li  class="active"><?php echo $this->Html->link(__l('Invite Friends'), array('controller' => 'user_friends', 'action' => 'import', 'admin' => false), array('title' => __l('Invite Friends'), 'escape' => false));?></li>
</ul>
...
<div>
	<div class="page-info">
		...
		<p>
			...
			<span><?php echo $this->Html->link(__l('Privacy Policy'), array('controller' => 'page', 'action' => 'privacy-guidelines'), array('target' => '_blank', 'class'=>'js-contact-thickbox'));?></span>
		</p>
	</div>
	<div class="js-tabs">
    	<ul class="clearfix menu-tabs">
