...
<?php 
	if($status == 'pending'):
?>
	 <div class="content-info"><?php echo __l('Your request will be confirmed after admin approval.'); ?> </div>
<?php 
...
<div class="user-add-form-block">
    <div class="content-info"><?php echo __l('This request will be confirmed after admin approval.'); ?> </div>
		<?php echo $this->Form->create('AffiliateRequest', array('class' => 'normal js-ajax-setting-form'));?>
			<?php
