	...
	<div class="tempContacts index">
		...
		<table class="list">
			...
			<tr<?php echo $class;?>>
					...
					<?}?>
					<td>
								<?php echo $this->Html->truncate($tempContact['TempContact']['contact_name'], 25); ?>
					</td>				
			...
			if (!empty($tempContacts) && $member != 1 && $member != 2): ?>
            	    <div class="submit-block clearfix">
                        ...
                        <div class="cancel-block">
                            <?php echo $this->Html->link(__l('Cancel'), array('controller' => 'users', 'action' => 'dashboard','admin' => false), array('class' => 'cancel-button')); ?>
                        </div>
                   </div>
		<?php
