	...
	?>
		<li class="clearfix <?php echo $class; ?>">
			...
			<div class="grid_14 omega alpha">
				<h3 class="list-view-title"><?php echo $this->Html->link($eventUser['User']['username'], array('controller' => 'users', 'action' => 'view', $eventUser['User']['username']), array('title' => $eventUser['User']['username'], 'escape' => false)); ?>
				<?php 
				...
				<p class="meta clearfix"><?php echo __l('Joined on: ') . $this->Html->cDateTime($eventUser['GuestListUser']['created']);?></p>
