...
?>
	<tr<?php echo $class;?>>
		...
		echo $this->Form->input('MoneyTransferAccount.checked', array('type' => 'radio', 'options' => $options ,'div'=>false, 'label' => false, 'legend' => false, 'value' => $moneyTransferAccount['MoneyTransferAccount']['id'])); ?><label for="MoneyTransferAccountChecked<?php echo $moneyTransferAccount['MoneyTransferAccount']['id']; ?>">
