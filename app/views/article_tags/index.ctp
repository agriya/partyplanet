...
<div class="articleTags js-response">
<h3><?php echo __l('Article Tags');?></h3>
	...
	foreach ($tag_arr AS $key => $value)
		{
            ...
            echo $this->Html->link($tag_name_arr[$key], array('controller'=> 'articles', 'action'=> 'index', 'tag'=>$key),array('class'=>'tag'.$size));
		}
	}else{
?>
