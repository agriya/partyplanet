...
<div class="affiliateCashWithdrawals index js-response js-admin-index-autosubmit-over-block">
    	...
    	<ul class="filter-list  active-links-block clearfix">
            <li><span class="suspended round-5"><?php echo $this->Html->link(__l('Pending').': '.$this->Html->cInt($pending ,false), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Pending), array('escape' => false, 'title' => __l('Pending'))); ?></span></li>
            <li><span class="active round-5"><?php echo $this->Html->link(__l('Success').': '.$this->Html->cInt($success ,false), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Success), array('escape' => false, 'title' => __l('Success'))); ?></span></li>
            <li><span class="inactive round-5"><?php echo $this->Html->link(__l('Failed').': '.$this->Html->cInt($failed ,false), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Failed), array('escape' => false, 'title' => __l('Failed'))); ?></span></li>
            <li><span class="yahoo round-5"><?php echo $this->Html->link(__l('Under Process').': '.$this->Html->cInt($approved ,false), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Approved), array('escape' => false, 'title' => __l('Approved'))); ?></span></li>
            <li><span class="canceled round-5"><?php echo $this->Html->link(__l('Rejected').': '.$this->Html->cInt($rejected ,false), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => ConstAffiliateCashWithdrawalStatus::Rejected), array('escape' => false, 'title' => __l('Rejected'))); ?></span></li>
            <li><span class="all round-5"><?php echo $this->Html->link(__l('All').': '.$this->Html->cInt($approved + $pending + $rejected + $success + $failed ,false), array('controller' => 'affiliate_cash_withdrawals', 'action' => 'index', 'filter_id' => 'all'), array('escape' => false, 'title' => __l('All'))); ?></span></li>
        </ul>
        ...
        <div class="grid_right">
            <h4 class="grid_left"><?php echo __l('Transfer Account: '); ?></h4>
            <ul class="transfer-list grid_right clearfix">
        		...
        		<li class="grid_left <?php echo $class ?>"><div class="js-pagination"><?php echo $this->Html->link(__l('All'), array('action' => 'index', 'filter_id' => $this->request->params['named']['filter_id'], 'account_id' => 'all'), array('title' => __l('All')));?></div></li>
