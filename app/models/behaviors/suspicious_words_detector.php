    ...
    function beforeSave(&$Model) 
    {
       ...
       if (!empty($this->__settings[$Model->alias]['fields']) && $this->__badWords) {
         ...
         foreach($Model->data as $row) {
            ...
            $suspend_array = array(
                'Event' => Configure::read('suspicious_detector.auto_suspend_event_on_system_flag') ,
                'EventComment' => Configure::read('suspicious_detector.auto_suspend_event_comment_on_system_flag') ,
                'Venue' => Configure::read('suspicious_detector.auto_suspend_venue_on_system_flag') ,
                'VenueComment' => Configure::read('suspicious_detector.auto_suspend_venue_comment_on_system_flag') ,
                'PhotoAlbum' => Configure::read('suspicious_detector.auto_suspend_photo_album_on_system_flag') ,
                'Photo' => Configure::read('suspicious_detector.auto_suspend_photo_on_system_flag') ,
                'PhotoComment' => Configure::read('suspicious_detector.auto_photo_comment_message_on_system_flag') ,
                'Article' => Configure::read('suspicious_detector.auto_suspend_article_on_system_flag') ,
                'ArticleComment' => Configure::read('suspicious_detector.auto_suspend_article_comment_on_system_flag') ,
                'UserComment' => Configure::read('suspicious_detector.auto_suspend_user_comment_on_system_flag') ,
                'Video' => Configure::read('suspicious_detector.auto_suspend_video_on_system_flag') ,
                'VideoComment' => Configure::read('suspicious_detector.auto_suspend_video_comment_on_system_flag') ,
                'MessageContent' => Configure::read('suspicious_detector.auto_suspend_message_on_system_flag') ,
                'Forum' => Configure::read('suspicious_detector.auto_suspend_forum_on_system_flag') ,
                'ForumComment' => Configure::read('suspicious_detector.auto_suspend_forum_comment_on_system_flag') ,
            );
