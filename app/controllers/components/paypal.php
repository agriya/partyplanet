...
class PaypalComponent extends Component
{
    ...
    public public function auth_process() 
    {
        $this->errno = 0; //initialize to no error
        $this->errno|= (strcmp($this->postResponse2PayPal() , 'VERIFIED') == 0) ? 0 : (1<<0);
        $this->errno|= (!$this->_isTransactionProcessed()) ? 0 : (1<<2);
    ...
    public public function postResponse2PayPal() 
    {
    ...
    public public function sanitizeServerVars($_POST) 
    {
    ...
    public public function logPaypalTransactions() 
    {
        ...
        $this->request->data['PaypalTransactionLog']['ip_id'] = $this->PaypalTransactionLog->toSaveIp();
        foreach($this->paypal_post_arr as $key => $value) {
            if (in_array($key, array(
                ...
                $this->request->data['PaypalTransactionLog']['is_authorization'] = 1;
            }
